use super::{
    ...
    Equipped, Hidden, HungerClock, HungerState, InBackpack, Item, MagicItem, MagicItemClass, Map,
    MasterDungeonMap, Name, ObfuscatedName, Pools, Position, RunState, State, Vendor, VendorMode,
    Viewshed,
};
