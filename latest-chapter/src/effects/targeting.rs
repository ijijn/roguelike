...
#[must_use] pub fn entity_position(ecs: &World, target: Entity) -> Option<i32> {
...
#[must_use] pub fn aoe_tiles(map: &Map, target: rltk::Point, radius: i32) -> Vec<i32> {
...
#[must_use] pub fn find_item_position(ecs: &World, target: Entity, creator: Option<Entity>) -> Option<i32> {
